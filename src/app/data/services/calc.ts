...
export const washersByGost: WashersByGost = {
  ...
  //     '12Х18Н10Т'
  //   ],
  //   description: 'Основные размеры (Таблица 1), мм. Параметры: nominal_thread_diameter (Номинальный диаметр резьбы), inner_diameter (d1, внутренний диаметр), outer_diameter (d2, наружный диаметр), thickness (s, толщина).',
  //   sizes: {
  //     'M6': {
  //       nominal_thread_diameter: 6.0,
  //       inner_diameter: 6.4, // Взято из оригинального ГОСТа, а не из вашего примера (где было 6.0)
  //       outer_diameter: 12.0,
  //       thickness: 2.0
  //     },
  //     'M8': {
  //       nominal_thread_diameter: 8.0,
  //       inner_diameter: 8.4,
  //       outer_diameter: 16.0,
  //       thickness: 2.5
  //     },
  //     'M10': {
  //       nominal_thread_diameter: 10.0,
  //       inner_diameter: 10.5,
  //       outer_diameter: 20.0,
  //       thickness: 3.0
  //     },
  //     'M12': {
  //       nominal_thread_diameter: 12.0,
  //       inner_diameter: 13.0,
  //       outer_diameter: 24.0,
  //       thickness: 3.0
  //     },
  //     'M16': {
  //       nominal_thread_diameter: 16.0,
  //       inner_diameter: 17.0,
  //       outer_diameter: 30.0,
  //       thickness: 3.5
  //     },
  //     'M20': {
  //       nominal_thread_diameter: 20.0,
  //       inner_diameter: 21.0,
  //       outer_diameter: 37.0,
  //       thickness: 4.0
  //     },
  //     'M24': {
  //       nominal_thread_diameter: 24.0,
  //       inner_diameter: 25.0,
  //       outer_diameter: 44.0,
  //       thickness: 4.5
  //     },
  //     'M30': {
  //       nominal_thread_diameter: 30.0,
  //       inner_diameter: 31.0,
  //       outer_diameter: 55.0,
  //       thickness: 5.0
  //     },
  //     'M36': {
  //       nominal_thread_diameter: 36.0,
  //       inner_diameter: 37.0,
  //       outer_diameter: 65.0,
  //       thickness: 5.0
  //     },
  //     'M42': {
  //       nominal_thread_diameter: 42.0,
  //       inner_diameter: 43.0,
  //       outer_diameter: 75.0,
  //       thickness: 6.0
  //     },
  //     'M48': {
  //       nominal_thread_diameter: 48.0,
  //       inner_diameter: 50.0,
  //       outer_diameter: 90.0,
  //       thickness: 6.0
  //     }
  ...
  //
  // "ГОСТ 10450-78": {
  // "title": "Шайбы уменьшенные. Классы точности А и С.",
  //   "standard": "ГОСТ 10450-78",
  //   "description": "Основные размеры (Таблица 1), мм. Внутренний диаметр 'd1' приведен для класса точности А.",
  //   "dimensions": [
  //   {
  //     "nominal_thread_diameter": 6.0,
  //     "inner_diameter": 6.4,
