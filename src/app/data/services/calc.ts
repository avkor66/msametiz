...
export const washersByGost: WashersByGost = {
  ...
  'ГОСТ 11371-78': {
    title: 'Шайбы плоские ГОСТ 11371-78. Класс точности А',
    type: 'шайба',
    steelGrades: [
      '40Х',
      '45',
    ...
    sizes: {
      'M12': {d: 12.0,D: 24.0, t: 3.0},
      'M16': {d: 16.0, D: 30.0, t: 3.5},
      'M20': {d: 20.0, D: 37.0, t: 4.0},
      'M24': {d: 24.0, D: 44.0, t: 4.5},
      'M30': {d: 30.0, D: 55.0, t: 5.0},
      'M36': {d: 36.0, D: 65.0, t: 5.0},
      'M42': {d: 42.0, D: 75.0, t: 6.0},
      'M48': {d: 48.0, D: 90.0, t: 6.0}
    }
  }
  }
...
export interface NutSizeData {
  ...
  S?: number;             // размер под ключ (мм) - добавлено для полноты
  D1?: number | null;            // наружный диаметр колпачка (для Типа Б)
...
export const nutsByGost: NutsByGost = {
  // ----------------------------------------------------------------------
  // 1. ГОСТ 5915-70: Гайки шестигранные (Класс точности B)
  // ----------------------------------------------------------------------
  'ГОСТ 5915-70': {
    title: 'Гайки шестигранные, класс точности В',
    type: 'гайка',
    thread: 'M',
    steelGrades: ['35', '40Х', '45', '09Г2С'],
    gost: 'ГОСТ 5915-70',
    sourceNote: 'Класс точности В, высота m < d',
    sizes: {
      M12: { P: 1.75, m: 10.0, S: 18, D1: null, designation: 'Гайка M12 ГОСТ 5915-70' },
      M16: { P: 2.0,  m: 13.0, S: 24, D1: null, designation: 'Гайка M16 ГОСТ 5915-70' },
      M20: { P: 2.5,  m: 16.0, S: 30, D1: null, designation: 'Гайка M20 ГОСТ 5915-70' },
      M24: { P: 3.0,  m: 19.0, S: 36, D1: null, designation: 'Гайка M24 ГОСТ 5915-70' },
      M30: { P: 3.5,  m: 24.0, S: 46, D1: null, designation: 'Гайка M30 ГОСТ 5915-70' },
      M36: { P: 4.0,  m: 29.0, S: 55, D1: null, designation: 'Гайка M36 ГОСТ 5915-70' },
      M42: { P: 4.5,  m: 34.0, S: 65, D1: null, designation: 'Гайка M42 ГОСТ 5915-70' },
      M48: { P: 5.0,  m: 39.0, S: 75, D1: null, designation: 'Гайка M48 ГОСТ 5915-70' },
    }
  },

  // ----------------------------------------------------------------------
  // 2. ГОСТ 9064-75 (Тип А): Шестигранная (Высокая)
  // ----------------------------------------------------------------------
  'ГОСТ 9064-75-А': {
    title: 'Гайки шестигранные (Тип А) для фланцевых соединений',
    type: 'гайка',
    thread: 'M',
    steelGrades: ['25', '35', '40Х', '25Х1МФ', '12Х18Н10Т'],
    gost: 'ГОСТ 9064-75',
    sourceNote: 'Тип А, Высота m = d, крупный шаг',
    sizes: {
      M12: { P: 1.75, m: 12.0, S: 19, D1: null, designation: 'Гайка M12-6Н ГОСТ 9064-75 (Тип А)' },
      M16: { P: 2.0,  m: 16.0, S: 24, D1: null, designation: 'Гайка M16-6Н ГОСТ 9064-75 (Тип А)' },
      M20: { P: 2.5,  m: 20.0, S: 30, D1: null, designation: 'Гайка M20-6Н ГОСТ 9064-75 (Тип А)' },
      M24: { P: 3.0,  m: 24.0, S: 36, D1: null, designation: 'Гайка M24-6Н ГОСТ 9064-75 (Тип А)' },
      M30: { P: 3.5,  m: 30.0, S: 46, D1: null, designation: 'Гайка M30-6Н ГОСТ 9064-75 (Тип А)' },
      M36: { P: 4.0,  m: 36.0, S: 55, D1: null, designation: 'Гайка M36-6Н ГОСТ 9064-75 (Тип А)' },
      M42: { P: 4.5,  m: 42.0, S: 65, D1: null, designation: 'Гайка M42-6Н ГОСТ 9064-75 (Тип А)' },
      M48: { P: 5.0,  m: 48.0, S: 75, D1: null, designation: 'Гайка M48-6Н ГОСТ 9064-75 (Тип А)' },
    }
  },

  // ----------------------------------------------------------------------
  // 3. ГОСТ 9064-75 (Тип Б): Колпачковая
  // ----------------------------------------------------------------------
  'ГОСТ 9064-75-Б': {
    title: 'Гайки колпачковые (Тип Б) для фланцевых соединений',
    type: 'гайка',
    thread: 'M',
    steelGrades: ['25', '35', '40Х', '25Х1МФ', '12Х18Н10Т'],
    gost: 'ГОСТ 9064-75',
    sourceNote: 'Тип Б, Колпачковая гайка',
    sizes: {
      M12: { P: 1.75, m: 21.0, S: 19, D1: 20, designation: 'Гайка M12-6Н ГОСТ 9064-75 (Тип Б)' },
      M16: { P: 2.0,  m: 28.0, S: 24, D1: 28, designation: 'Гайка M16-6Н ГОСТ 9064-75 (Тип Б)' },
      M20: { P: 2.5,  m: 35.0, S: 30, D1: 34, designation: 'Гайка M20-6Н ГОСТ 9064-75 (Тип Б)' },
      M24: { P: 3.0,  m: 42.0, S: 36, D1: 40, designation: 'Гайка M24-6Н ГОСТ 9064-75 (Тип Б)' },
      M30: { P: 3.5,  m: 52.0, S: 46, D1: 50, designation: 'Гайка M30-6Н ГОСТ 9064-75 (Тип Б)' },
      M36: { P: 4.0,  m: 62.0, S: 55, D1: 60, designation: 'Гайка M36-6Н ГОСТ 9064-75 (Тип Б)' },
      M42: { P: 4.5,  m: 72.0, S: 65, D1: 70, designation: 'Гайка M42-6Н ГОСТ 9064-75 (Тип Б)' },
      M48: { P: 5.0,  m: 82.0, S: 75, D1: 80, designation: 'Гайка M48-6Н ГОСТ 9064-75 (Тип Б)' },
    }
  },

  // ----------------------------------------------------------------------
  // 4. ГОСТ 5927-70: Гайки шестигранные (Класс точности А) - НОВЫЙ ГОСТ
  // ----------------------------------------------------------------------
  'ГОСТ 5927-70': {
    title: 'Гайки шестигранные, класс точности А',
    type: 'гайка',
    thread: 'M',
    steelGrades: ['35', '40Х', '45', '09Г2С'],
    gost: 'ГОСТ 5927-70',
    sourceNote: 'Класс точности А, аналогичен DIN 934, высота m < d',
    sizes: {
      M12: { P: 1.75, m: 9.6, S: 19, D1: null, designation: 'Гайка M12 ГОСТ 5927-70' },
      M16: { P: 2.0,  m: 13.0, S: 24, D1: null, designation: 'Гайка M16 ГОСТ 5927-70' },
      M20: { P: 2.5,  m: 16.0, S: 30, D1: null, designation: 'Гайка M20 ГОСТ 5927-70' },
      M24: { P: 3.0,  m: 19.0, S: 36, D1: null, designation: 'Гайка M24 ГОСТ 5927-70' },
      M30: { P: 3.5,  m: 24.0, S: 46, D1: null, designation: 'Гайка M30 ГОСТ 5927-70' },
      M36: { P: 4.0,  m: 29.0, S: 55, D1: null, designation: 'Гайка M36 ГОСТ 5927-70' },
      M42: { P: 4.5,  m: 34.0, S: 65, D1: null, designation: 'Гайка M42 ГОСТ 5927-70' },
      M48: { P: 5.0,  m: 38.0, S: 75, D1: null, designation: 'Гайка M48 ГОСТ 5927-70' },
    }
  }
};
...
export class CalcService {
  ...
  /**
   * Возвращает список доступных номинальных диаметров (например, ['M6', 'M8', 'M10']).
   * @param stateStandard Ключ ГОСТа (например, 'ГОСТ 7798-70').
   * @returns Массив строк с доступными диаметрами.
   */
  static getAvailableBoltDiameter(stateStandard: keyof typeof boltsByGost): string[] {
    const gostData = boltsByGost[stateStandard];

    // Проверка наличия данных для данного ГОСТа и раздела sizes
    if (gostData && gostData.sizes) {
      return Object.keys(gostData.sizes);
    }
    return [];
  }

  /**
   * Возвращает список доступных длин для заданного диаметра и ГОСТа.
   * Длины генерируются на основе range [min, max] и step.
   * @param stateStandard Ключ ГОСТа (например, 'ГОСТ 7798-70').
   * @param diameter Номинальный диаметр (например, 'M12').
   * @returns Массив строк с доступными длинами.
   */
  static getAvailableBoltLengths(stateStandard: keyof typeof boltsByGost, diameter: string): string[] {

    // 1. Получаем объект со спецификациями для данного диаметра
    const sizeData = boltsByGost[stateStandard]?.sizes?.[diameter];

    // Если данные не найдены, возвращаем пустой массив
    if (!sizeData) return [];

    // 2. Деструктурируем range и step
    const [min, max] = sizeData.range;
    const { step } = sizeData;

    // 3. Создаём список длин
    const result: string[] = [];
    for (let l = min; l <= max; l += step) {
      result.push(l.toString());

      // Защита от бесконечного цикла, если step = 0 или ошибка в range
      if (l >= max && step > 0) break;
    }
...
// Пример использования (если boltsByGost['ГОСТ 7798-70'] существует):
/*
const diameters = CalcService.getAvailableBoltDiameter('ГОСТ 7798-70'); // ['M6', 'M8', 'M10', ...]
console.log(diameters);

const lengths = CalcService.getAvailableBoltLengths('ГОСТ 7798-70', 'M12'); // ['20', '30', '40', ...]
console.log(lengths);
*/

//Болты
export interface BoltSizeData {
  P: number;              // Шаг резьбы (мм) - Крупный
  S: number;              // Размер под ключ (мм)
  k: number;              // Высота головки (мм)
  designation?: string;   // Обозначение болта
  range: [number, number]; // [Lmin, Lmax] (мм) - Типичный диапазон длин
  step: number;            // Шаг изменения длины (мм)
}

export interface GostBoltData {
  title: string;
  type: 'болт';
  ...
  gost: string;
  sourceNote?: string;
  sizes: Record<string, BoltSizeData>;
}

export const boltsByGost: Record<string, GostBoltData> = {
  // ----------------------------------------------------------------------
  // ГОСТ 7798-70: Болты шестигранные (Класс точности B)
  // ----------------------------------------------------------------------
  'ГОСТ 7798-70': {
    ...
    // Объединенные марки стали для классов прочности 5.8, 8.8, 10.9, 12.9
    steelGrades: ['Ст3', '10', '20', '35', '40', '35Х', '30Х3МФ'],
    gost: 'ГОСТ 7798-70',
    sourceNote: 'Стандартный болт общего назначения. Геометрические параметры соответствуют крупному шагу резьбы.',
    sizes: {
